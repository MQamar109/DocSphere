...
class ProjectDocumentBase(BaseModel):
    """
    Abstract base model for project and document models.
...
class Project(ProjectDocumentBase):
    """
    A project belonging to an organization. Contains documents
    and can have user permissions assigned via
    ProjectPermissions.
    """
...
class Document(ProjectDocumentBase):
    """
    A document within a project. Can have user-level
    permissions assigned via DocumentPermissions.
    """
...
class ProjectPermissions(BaseModel):
    """
    Through model for user-project access. Links a user to a
    project with a permission level: add, remove, or all.
    """
...
class DocumentPermissions(BaseModel):
    """
    Through model for user-document access. Links a user to a
    document with a permission level: read, write, or all.
    """
